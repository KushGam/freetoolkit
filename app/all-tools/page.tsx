  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-10">
      <section className="rounded-[2rem] border border-slate-200 bg-[radial-gradient(circle_at_top_left,#dbeafe,transparent_36%),linear-gradient(180deg,#ffffff,#f8fafc)] p-6 shadow-[0_24px_70px_rgba(15,23,42,0.08)] sm:p-8">
        ...
        <p className="mt-4 max-w-3xl text-lg leading-8 text-slate-600">Search every free FreeToolKit utility across Everyday, Student, AI Tools, and Developer. Tools are organized for quick access and designed to work without login or paid APIs.</p>
      </section>
