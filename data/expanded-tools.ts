...
export const expandedTools: Tool[] = [
  ...
  makeTool({ slug: "edit-pdf", title: "Edit PDF", category: "PDF Tools", description: "Edit PDF pages online with page-level actions like rotate, delete, and reorder.", action: "update PDF page structure quickly without desktop software", audience: "students, office teams, freelancers, and document managers", limitation: "This browser-first editor focuses on page-level edits and does not support rich text reflow like full desktop PDF suites." }),
